...
LOCAL_ASSET_DIR = f"source/isaaclab_assets/data"
...
TABLE_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{LOCAL_ASSET_DIR}/Props/Mounts/UWPatVention/pat_vention.usd",
...
NISTBOARD_CFG = RigidObjectCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{LOCAL_ASSET_DIR}/Props/NIST/Taskboard/nistboard.usd",
        rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True),
    ),
    init_state=RigidObjectCfg.InitialStateCfg(pos=(0.6, 0.0, 0.00)),
)
